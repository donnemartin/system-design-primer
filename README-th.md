...
> เรียนรู้ว่าออกแบบระบบขนาดใหญ่อย่างไร? 
>
> เตรียมตัวสำหรับสัมภาษณ์ออกแบบระบบ

### เรียนรู้ว่าออกแบบระบบขนาดใหญ่อย่างไร?

เรียนรู้ว่าออกแบบระบบที่สามารถขยายได้จะช่วยให้เรากลายเป็นวิศวกรที่ดีขึ้น

ออกแบบระบบเป็นหัวข้อที่กว้างมาก **มันมีแหล่งข้อมูลมากมายกระจายอยู่ตามเว็บต่างๆ** ในหัวข้อหลักการออกแบบระบบ

นี้เป็น repos **ที่รวบรวมและจัดระเบียบ** ของแหล่งข้อมูลต่างๆ เพื่อช่วยให้คุณได้เรียนรู้ว่าสร้างระบบที่สามารถขยายได้นั้นทำอย่างไร

### เรียนรู้จากชุมชน open source

นี้เป็นแบบร่างเริ่มต้นของแหล่งข้อมูลที่จะอัพเดตอย่างต่อเนื่อง ของโครงการ open source

[]()
ยินดีต้อนรับ [การมีส่วนร่วม](#contributing)!

### เตรียมตัวสำหรับสัมภาษณ์ออกแบบระบบ

ในส่วนเพิ่มเติมสำหรับการสัมภาษณ์เขียนโค้ด การออกแบบระบบเป็น **ส่วนที่จำเป็นต้องใช้** สำหรับ **กระบวนการสัมภาษณ์เชิงเทคนิค** ในหลายๆ บริษัทเทคโนโลยี

**ฝึกสำหรับคำถามทั่วไปของการออกแบบระบบ** และ **เปรียบเทียบ** คำตอบของคุณกับ **ตัวอย่างเฉลยของแนวทางแก้ปัญหา** นั้น: อภิปราย, โค้ด และวาดแผนผัง

หัวข้อเพิ่มเติมสำหรับเตรียมตัวสัมภาษณ์:

* [แนวทางการเรียนรู้](#study-guide)
* [วิธีการตอบคำถามการสัมภาษณ์ออกแบบระบบอย่างไร](#how-to-approach-a-system-design-interview-question)
* [คำถามการสัมภาษณ์ออกแบบระบบ, **ด้วยแนวทางแก้ไขปัญหา**](#system-design-interview-questions-with-solutions)
* [คำถามการสัมภาษณ์ออกแบบเชิงวัตถุ **ด้วยแนวทางแก้ไขปัญหา**](#object-oriented-design-interview-questions-with-solutions)
* [เพิ่มเติมคำถามการสัมภาษณ์ออกแบบระบบ](#additional-system-design-interview-questions)
...
มี [สำรับ Anki flashcard](https://apps.ankiweb.net/) ใช้วิธีเว้นระยะห่างเพื่อช่วยให้คุณรักษาจุดสำคัญของแนวคิดการออกแบบระบบ

* [สำรับการออกแบบระบบ](resources/flash_cards/System%20Design.apkg)
* [สำรับแบบฝึกหัดการออกแบบระบบ](resources/flash_cards/System%20Design%20Exercises.apkg)
* [สำรับแบบฝึกหัดการออกแบบเชิงวัตถุ](resources/flash_cards/OO%20Design.apkg)

เหมาะสำหรับการใช้งานขณะกำลังเดินทาง

### แหล่งข้อมูลการการเชียนโปรแกรม: ความท้ายในการเขียนโปรแกรมเชิงโต้ตอบ

มองหาแหล่งข้อมูลที่ช่วยคุณเตรียมสำหรับ  [**การสัมภาษณ์เขียนโปรแกรม**](https://github.com/donnemartin/interactive-coding-challenges)?
...
ตรวจสอบ repo พี่น้องได้ที่ [**ความท้ายในการเขียนโปรแกรมเชิงโต้ตอบ**](https://github.com/donnemartin/interactive-coding-challenges), ซึ่งมี Anki deck เพิ่มเติม:

* [สำรับ Coding](https://github.com/donnemartin/interactive-coding-challenges/tree/master/anki_cards/Coding.apkg)

## การมีส่วนรวม

> เรียรู้จากชุมชน

คุณสามารถส่ง Pull request เพื่อช่วยเหลือได้ดังนี้:

* แก้ไขข้อผิดพลาด
* ปรับปรุงเนื้อหาของแต่ละหัวข้อ
* เพิ่มเติมหัวข้อใหม่
* [แปล](https://github.com/donnemartin/system-design-primer/issues/28)

เนื้อหาที่จำเป็นต้องขัดเกลาคือ [กำลังพัฒนา](#under-development)

รีวิว [แนวทางการมีส่วนร่วม](CONTRIBUTING.md)

## สารบัญหัวข้อการออกแบบระบบ

> การสรุปของหัวข้อการแบบแบบระบบที่หลากหลาย รวมทั้งข้อดีและข้อเสีย **ทุกๆ สิ่งคือ trade-off**
>
> แต่ล่ะหัวข้อจะมีลิงค์ไปยังแหล่งข้อมูลเชิงลึกเพิ่มเติม
...
* [หัวข้อการออกแบบระบบ: เริ่มต้นที่นี่](#system-design-topics-start-here)
    * [ขั้นตอนที่ 1: รีวิววีดีโอบรรยายหัวข้อความสามารถในการขยายได้](#step-1-review-the-scalability-video-lecture)
    * [ขั้นตอนที่ 2: รีวิวบทความความสามารถในการขยายได้](#step-2-review-the-scalability-article)
    * [ขั้นตอนต่อไป](#next-steps)
* [ประสิทธิภาพ vs ความสามารถในการขยายได้](#performance-vs-scalability)
* [วัดความเร็ว vs ปริมาณข้อมูล](#latency-vs-throughput)
* [ความพร้อมใช้งาน vs ความสม่ำเสมอ](#availability-vs-consistency)
    * [ทฤษฎีบท CAP](#cap-theorem)
        * [CP - ความสม่ำเสมอและความคลาดเคลื่อนของพาร์ทิชัน](#cp---consistency-and-partition-tolerance)
        * [AP - ความพร้อมใช้งานและความคลาดเคลื่อนของพาร์ทิชัน](#ap---availability-and-partition-tolerance)
* [แบบแผนความสม่ำเสมอ](#consistency-patterns)
    * [ความสม่ำเสมอแบบอ่อน](#weak-consistency)
    * [ความสม่ำเสมอแบบในท้ายที่สุด](#eventual-consistency)
    * [ความสม่ำเสมอแบบแข็ง](#strong-consistency)
* [แบบแผนความพร้อมใช้งาน](#availability-patterns)
    * [ล้มเหลวเกิน](#fail-over)
    * [การทำซ้ำ](#replication)
* [ระบบโดเมนเนม](#domain-name-system)
* [เครือข่ายจัดส่งเนื้อหา](#content-delivery-network)
    * [CDNs แบบพลัก](#push-cdns)
    * [CDNs แบบดึง](#pull-cdns)
* [โหลดบารานเซอร์](#load-balancer)
    * [Active-passive](#active-passive)
    * [Active-active](#active-active)
    * [การทำงานโหลดบารานซ์ 4 ชั้น](#layer-4-load-balancing)
    * [การทำงานโหลดบารานซ์ 7 ชั้น](#layer-7-load-balancing)
    * [การขนายในแนวนอน](#horizontal-scaling)
* [พรอกซี่หันกลับ (เว็บเซอร์เวอร์)](#reverse-proxy-web-server)
    * [โหลดบารานเซอร์ vs พรอกซี่หันกลับ](#load-balancer-vs-reverse-proxy)
* [ชั้นแอพพลิเคชั้น](#application-layer)
    * [ไอโครเซอร์วิส](#microservices)
    * [เซอร์วิสดิสโคเวอรี่](#service-discovery)
* [ฐานข้อมูล](#database)
    * [ระบบจัดการฐานข้อมูลเชิงสัมพันธ์ (RDBMS)](#relational-database-management-system-rdbms)
        * [การทำซ้ำแบบ มาสเตอร์-สลาฟ](#master-slave-replication)
        * [การทำซ้ำแบบ มาสเตอร์-มาสเตอร์](#master-master-replication)
        * [การรวมกัน](#federation)
        * [Sharding](#sharding)
