...
* [スケーラビリティ、可用性、安定性、パターン](https://speakerdeck.com/jboner/scalability-availability-and-stability-patterns/)
...
* [スケーラビリティ、 可用性、 スタビリティ パターン](https://speakerdeck.com/jboner/scalability-availability-and-stability-patterns/)
