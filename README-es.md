...
>
> Preparse para entrevista de diseño de sistemas.
...
El diseño de sistemas es un tema amplio. Hay una **gran cantidad de recursos dispersos en la web** sobre principios de diseño.

Este repo es una **colección organizada** de recursos que te ayudarán a aprender cómo se debe construir sistemas a escala.

### Aprende desde la comunidad open source

Este es un borrador inicial de un proyecto de código abierto continuamente actualizado.


¡[Contribuciones](#contribuciones) son bienvenidas!

### Pepararse para la entrevista de diseño de sistemas 

Además de las pruebas de programación, el diseño de sistemas es un **componente requerido** en los procesos de intrevista técnicas en muchas compañias.   

**Debes practiar las preguntas que se realizan comúnmente en las entrevistas** y **comparar** tus respuestas con los resultos de las **soluciones de ejemplo**: discusiones, código y diagramas.

Témas adicionales para la preparación de la entrevista:

* [Guía de estudio](#guia-estudio)
* [Cómo abordar una pregunta de entrevista sobre el diseño de sistemas](#como-abordar-una-pregunta-de-entrevista-sobre-el-diseno-de-sistemas)
* [Preguntas de diseño de sistemas, **con soluciones**](#preguntas-de-diseno-de-sistemas-con-soluciones)
* [Preguntas de entrevista de diseño orientado a objetos, **con soluciones**](#preguntas-de-entrevista-de-diseno-orientado-a-objetos-con-soluciones)
* [Preguntas de entrevistas adicionales sobre el diseño de sistemas](#preguntas-de-entrevistas-adicionales-sobre-el-diseño-de-sistemas)
...
Las [Anki flashcard decks](https://apps.ankiweb.net/) que se proveen utilzan repeticiones espaciadas para ayudarlo a conservar los conceptos claves de diseño de sistemas

* [Barajas sobre diseño de sistemas](resources/flash_cards/System%20Design.apkg)
* [Barajas sobre ejercicios de diseño de sistemas](resources/flash_cards/System%20Design%20Exercises.apkg)
* [Barajas con ejercicios de diseño orientado a objetos](resources/flash_cards/OO%20Design.apkg)

Ideal para usarlo mientras haces otras cosas. 

### Recursos de programaćión: Reto de programación interactiva

¿Estas buscando recursos para ayudarte a prepar las [**entrevistas de programación**](https://github.com/donnemartin/interactive-coding-challenges)?
...
Hecha un vistazo al repo [**Interactive Coding Challenges**](https://github.com/donnemartin/interactive-coding-challenges), el cual contiene una baraja adicional Anki:
...
Siéntete libre para enviar pull request que ayuden a:
...
Revise, las [directrices de contribución](CONTRIBUTING.md).
