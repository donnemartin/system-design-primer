...
> Aprenda como projetar sistemas de larga escala.
>
> Prepare-se para entrevistas sobre projeto de sistemas.

### Aprenda como projetar sistemas de larga escala

Aprender como projetar sistemas de larga escala irá ajudá-lo a ser tornar um engenheiro melhor.

System design é um assunto vasto. Existe um **grande número de fontes espalhadas na internet** sobre os princípios de system design.

Este repositório é uma **coleção organizada** de fontes para ajudá-lo a aprender como construir sistemas de larga escala.

### Aprenda com a comunidade open source

Este é um projeto open source continuamente atualizado.

[Contribuidores](#contributing) são bem vindos!

### Prepare-se para entrevistas sobre system design

Adicionalmente em entrevisitas que tem código, system design é um **componente obrigatório** do **processo de entrevistas técnicas** na maioria das empresas.

**Pratique perguntas comuns sobre system design** e **compare** os resultados com as **soluções simples**: discussões, código fonte, and diagramas.

Assuntos adicionais sobre a preparação para a entrevista:

* [Guia de estudo](#study-guide)
* [Como abordar uma questão de entrevista de design de sistema](#how-to-approach-a-system-design-interview-question)
* [Perguntas de entrevistas sobre System design, **com respostas**](#system-design-interview-questions-with-solutions)
* [Perguntas de entrevistas sobre Orientação a objeto, **com respostas**](#object-oriented-design-interview-questions-with-solutions)
* [Perguntas adicionais sobre system design](#additional-system-design-interview-questions)
