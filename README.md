...
In Systems like Apache Kafka we can set up parallel consumers (those needn't acknowledge before another set of message comes to them). Backpressure comes to effect in this scenario as well if you want to hold the producer from overwhelming the consumer.
