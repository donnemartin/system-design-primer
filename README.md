...
- DNS services have recently come under [DDoS attack](https://www.kaspersky.com/resource-center/threats/ddos-attacks), preventing users from accessing websites such as Twitter without knowing Twitter's IP address(es).
